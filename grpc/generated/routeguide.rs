...
pub mod protos {
    include!(concat!(
        env!("OUT_DIR"),
        "/protobuf_generated/generated/generated.rs"
    ));
}
...
pub mod route_guide_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_feature(
            &mut self,
            request: impl tonic::IntoRequest<super::protos::Point>,
        ) -> std::result::Result<tonic::Response<super::protos::Feature>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = crate::codec::ProtoCodec::default();
        ...
        pub async fn list_features(
            &mut self,
            request: impl tonic::IntoRequest<super::protos::Rectangle>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::protos::Feature>>,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
        ...
        pub async fn record_route(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::protos::Point>,
        ) -> std::result::Result<tonic::Response<super::protos::RouteSummary>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        pub async fn route_chat(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::protos::RouteNote>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::protos::RouteNote>>,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
...
pub mod route_guide_server {
    ...
    pub trait RouteGuide: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn list_features(
            &self,
            request: tonic::Request<super::protos::Rectangle>,
        ...
        async fn record_route(
            &self,
            request: tonic::Request<tonic::Streaming<super::protos::Point>>,
        ) -> std::result::Result<tonic::Response<super::protos::RouteSummary>, tonic::Status>;
        /// Server streaming response type for the RouteChat method.
        type RouteChatStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::protos::RouteNote, tonic::Status>,
            > + std::marker::Send
            + 'static;
        /// A Bidirectional streaming RPC.
        ///
        ...
        async fn route_chat(
            &self,
            request: tonic::Request<tonic::Streaming<super::protos::RouteNote>>,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/routeguide.RouteGuide/GetFeature" => {
                    ...
                    impl<T: RouteGuide> tonic::server::UnaryService<super::protos::Point> for GetFeatureSvc<T> {
                        type Response = super::protos::Feature;
                ...
                "/routeguide.RouteGuide/ListFeatures" => {
                    ...
                    impl<T: RouteGuide>
                        tonic::server::ServerStreamingService<super::protos::Rectangle>
                ...
                "/routeguide.RouteGuide/RecordRoute" => {
                    ...
                    impl<T: RouteGuide> tonic::server::ClientStreamingService<super::protos::Point>
                        for RecordRouteSvc<T>
                    {
                        type Response = super::protos::RouteSummary;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<tonic::Streaming<super::protos::Point>>,
                ...
                "/routeguide.RouteGuide/RouteChat" => {
                    ...
                    impl<T: RouteGuide> tonic::server::StreamingService<super::protos::RouteNote> for RouteChatSvc<T> {
                        type Response = super::protos::RouteNote;
