...
pub mod route_guide_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// position.
        pub fn get_feature<'a>(&'a mut self, p: super::Point) -> GetFeatureCall<'a, T> {
            let mut request = tonic::Request::new(p);
            request
                .extensions_mut()
        ...
        // OR with generics:
        pub fn get_feature_gen(
            &mut self,
            p: super::Point,
        ) -> UnaryCall<T, super::Point, super::Feature> {
            let mut request = tonic::Request::new(p);
            request
                .extensions_mut()
                .insert(GrpcMethod::new("routeguide.RouteGuide", "GetFeature"));
        ...
        pub fn route_chat<'a>(&'a mut self) -> RouteChatCall<'a, T> {
            RouteChatCall {
                inner: &mut self.inner,
            }
        }
    ...
    pub struct UnaryCall<'a, T, Req, Res> {
        inner: &'a mut tonic::client::Grpc<T>,
        request: tonic::Request<Req>,
        resp: Option<tonic::Response<Res>>,
    }

    impl<'a, T, Req, Res> UnaryCall<'a, T, Req, Res>
    where
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        // If Response<>s are reusable:
        pub fn use_response(mut self, resp: tonic::Response<Res>) -> Self {
            self.resp = Some(resp);
            self
        }
        pub fn use_response_msg(mut self, resp: Res) -> Self {
            self.resp = Some(tonic::Response::new(resp));
            self
        }
        pub async fn call(self) -> Result<tonic::Response<Res>, tonic::Status> {
            let mut resp = self
                .resp
                .unwrap_or_else(|| tonic::Response::new(Res::default()));

            // This logic will be moved inside the channel:
            ...
            let resp2 = self.inner.unary(self.request, path, codec).await?;
            // Obviously can't re-use resp.msg as-is, so we copy it in for now.
            (
                *resp.metadata_mut(),
                *resp.get_mut(),
                *resp.extensions_mut(),
    ...
    pub struct GetFeatureCall<'a, T> {
        inner: &'a mut tonic::client::Grpc<T>,
        request: tonic::Request<super::Point>,
        resp: Option<tonic::Response<super::Feature>>,
    }
    impl<'a, T> GetFeatureCall<'a, T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
    ...
    {
        // If Response<>s are reusable:
        pub fn use_response(mut self, resp: tonic::Response<super::Feature>) -> Self {
            self.resp = Some(resp);
            self
        }
        pub fn use_response_msg(mut self, resp: super::Feature) -> Self {
            self.resp = Some(tonic::Response::new(resp));
            self
        }
        pub async fn call(self) -> Result<tonic::Response<super::Feature>, tonic::Status> {
            let mut resp = self
                .resp
                .unwrap_or_else(|| tonic::Response::new(super::Feature::default()));
    ...
    pub struct RouteChatCall<'a, T> {
        inner: &'a mut tonic::client::Grpc<T>,
    }
    impl<'a> RouteChatCall<'a, tonic::transport::Channel> {
        pub async fn call(
            self,
            request: impl tokio_stream::Stream<Item = super::RouteNote> + Send + 'static,
